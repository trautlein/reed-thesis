...
senate_R_113 <- senate_R %>% filter(cong == 113)
senate_D_113 <- senate_D %>% filter(cong == 113)
senate_113 <- dplyr::bind_rows(senate_D_113, senate_R_113)
...
house_R_113 <- house_R %>% filter(cong == 113)
house_D_113 <- house_D %>% filter(cong == 113)
house_113 <- dplyr::bind_rows(house_D_113, house_R_113)
...
```{r echo=F}
# label(path = "~thesis/trautlein_thesis/figures/PlotHouseMeans.pdf",
#       caption = "Here is a caption",
#       label = "let's try this out")
```
